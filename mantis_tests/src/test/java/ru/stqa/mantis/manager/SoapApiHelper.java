...
public class SoapApiHelper extends HelperBase {
    ...
    public SoapApiHelper(ApplicationManager manager) {
        super(manager);
        //создать клиент для взаимодействия с Мантис
        //инициализация клиента при вызове помощника
        try {
    ...
    public void createIssue(IssueData issueData) {
        try {
            ...
            var issue = new biz.futureware.mantis.rpc.soap.client.IssueData(); //одинаковые именв у двух классов, поэтому в имени название пакета
